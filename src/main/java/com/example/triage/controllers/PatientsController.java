...
public class PatientsController {
    ...
    private VBox createPatientCard(String id, String name, int age, String gender,
        ...
        card.setOnMouseClicked(e -> showPatientDetails(id, name, age, gender, severity, bed, admission));
        ...
        viewBtn.setOnAction(e -> showPatientDetails(id, name, age, gender, severity, bed, admission));

        card.getChildren().addAll(header, nameBox, infoBox, bedBox, separator, viewBtn);
    ...
    private void showPatientDetails(String id, String name, int age, String gender,
        ...
        detailSeverity.setStyle("-fx-font-size: 14px; -fx-font-weight: bold; -fx-text-fill: " + severityColor + ";");

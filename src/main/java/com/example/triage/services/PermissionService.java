...
public class PermissionService {
    ...
    public static boolean canTransfer(
        ...
        // Nurse & Technician:
        // ONLY inpatient → inpatient
        return isNurseOrTechnician()
                && isInpatient(fromFacilityType)
                && isInpatient(toFacilityType);
    }

    private static boolean isInpatient(String type) {
        return "WARD".equals(type) || "ICU".equals(type);
    }
